...
SRCS+=$(KTOP)/lib/hashtable.c
SRCS+=$(KTOP)/lib/heap.c
...
SRCS+=$(KTOP)/test/hashtabletest.c
SRCS+=$(KTOP)/test/heaptest.c
SRCS+=$(KTOP)/test/kmalloctest.c
SRCS+=$(KTOP)/test/listtest.c
SRCS+=$(KTOP)/test/netqueuetest.c
SRCS+=$(KTOP)/test/queuetest.c
